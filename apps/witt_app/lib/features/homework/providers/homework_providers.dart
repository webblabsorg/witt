...
class HomeworkSessionNotifier extends Notifier<HomeworkSessionState> {
  ...
  Future<void> solve() async {
    ...
    // Phase 2: stub solver — Phase 3 will wire AI
    await Future.delayed(const Duration(milliseconds: 800));

    final solution = _generateStubSolution(
  ...
  List<SolutionStep> _buildStepsForSubject(
      HomeworkSubject subject, String question) {
    return switch (subject) {
      ...
      HomeworkSubject.physics => [
          ...
          const SolutionStep(
            ...
            content: 'Check units and ensure the answer is physically reasonable.',
          ),
        ],
      HomeworkSubject.chemistry => [
          ...
          const SolutionStep(
            ...
            type: SolutionStepType.calculation,
            title: 'Calculate',
            content: 'Perform the mole calculations and convert to required units.',
          ),
          const SolutionStep(
            stepNumber: 4,
            type: SolutionStepType.conclusion,
            title: 'State the result',
            content: 'Express the answer with correct significant figures and units.',
          ),
        ],
      _ => [
          const SolutionStep(
          ...
          const SolutionStep(
            ...
            content:
                'Check your answer for completeness, accuracy, and clarity.',
          ),
        ],
    };
  }
  ...
  String _stubAnswer(HomeworkSubject subject) => switch (subject) {
        HomeworkSubject.mathematics => 'x = 42 (calculated via step-by-step solution)',
        ...
        HomeworkSubject.biology => 'The process involves mitosis with 4 daughter cells.',
        HomeworkSubject.english => 'The theme explores the conflict between individual freedom and societal norms.',
